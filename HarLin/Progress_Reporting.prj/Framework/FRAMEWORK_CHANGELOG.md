...
- Valuation framework v0.1: stage-gated EV with cost floor, bands, anti-gaming rules.
- Report template v0.2 keyed to capture map; runbook v0.1; snapshot log started (2 data points).
- Scripts: snapshot_pillars.py (D3 automation), validate_report.py (filing gate).

## v0.1 — 2026-07-11
- PLAN_v0.1 + research briefs A/B. Project scaffolded 2026-07-10 via catalog.
