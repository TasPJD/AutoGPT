# Glossary — reading the Progress Report without the jargon

Kept per decision D2: reports are written to be picked up by any of the family (Harry, Lincoln, Madeline, Shanice, Tim), not just Paul. If a report term isn't here and isn't plain English, that's a defect — add it.
...
| **AWAITING CONFIRM** | The queue of decisions waiting on Paul. Its size and clear-rate is pillar 5 — a measure of whether the system reduces Paul's load |
| **The catalog / System of Record** | The master register of everything HarLin owns and builds |
| **Alfred / AEOS** | The AI concierge system running HarLin's operations; its go-live (11 July 2026) is the before/after line the reports measure |
| **The harness** | The technical scaffolding that lets AI agents work on HarLin safely and repeatably |
| **Pulse** | The automatic log of every working session — who did what, when |
| **Backfill** | Reports written after the fact for April–July 2026 from records kept at the time, with honesty markers on every claim |
